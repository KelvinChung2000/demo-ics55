...
`endif
 ...
 //E
        input  [3:0] W_GBUF_FEED_END,        //TilePort({E} INPUT W_GBUF_FEED_END[3:0])
        output  [3:0] E_GBUF_BEG,        //TilePort({E} OUTPUT E_GBUF_BEG[3:0])
 //W
        output  [3:0] W_GBUF_FEED_BEG,        //TilePort({W} OUTPUT W_GBUF_FEED_BEG[3:0])
        input  [3:0] E_GBUF_END,        //TilePort({W} INPUT E_GBUF_END[3:0])
        input  A_OUT_top,
        output  A_IN_top,
        output  A_EN_top,
